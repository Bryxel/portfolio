    ...
    <section id="contact" className="py-20 bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg">Have a project in mind? Let's make it happen.</p>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300">
                ...
                <div className="group">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:bryxelf@gmail.com" className="text-white hover:text-blue-400 transition-colors duration-300">bryxelf@gmail.com</a>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex justify-center space-x-4">
                  <a href="https://github.com/Bryxel" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-blue-500/20 transition-all duration-300 group">
                  ...
                  <a href="https://www.linkedin.com/in/bryxel/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-blue-500/20 transition-all duration-300 group">
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-blue-400 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
